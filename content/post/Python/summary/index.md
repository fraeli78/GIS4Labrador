...
- [7 Geocoding and Reverse Geocoding Services for Pinpointing Addresses (Free and Paid)](https://gisgeography.com/reverse-geocoding-services-addresses-free-paid/)
- [Anaconda - Correcting Install Paths](https://github.com/landlab/landlab/wiki/Correcting-Install-Paths)
- [Correct address format to get the most accurate results from google GeoCoding API](https://stackoverflow.com/questions/7764244/correct-address-format-to-get-the-most-accurate-results-from-google-geocoding-ap)
